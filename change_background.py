...
def set_angle():
    ...
    with open('/home/stan/Projects/Other/moon-phases/img-schedule-2019.json', 'r') as f:
...
def set_background(pic_id):
    pic_base = "/home/stan/Projects/Other/moon-phases/images/near_side_1024x1024x8/{}.png"
